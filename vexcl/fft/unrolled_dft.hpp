...
static std::string in_place_dft(size_t n, bool invert) {
    switch(n) {
        ...
        case 3: return invert ?
            ...
            " */\n"
            "void\n"
            "dft3 (real2_t * v0, real2_t * v1, real2_t * v2)\n"
            "{\n"
        ...
        case 4: return invert ?
            ...
            " * 12 stack variables, 0 constants, and 16 memory accesses\n"
            " */\n"
            "void\n"
            "dft4 (real2_t * v0, real2_t * v1, real2_t * v2, real2_t * v3)\n"
            "{\n"
            "    {\n"
        ...
        case 5: return invert ?
            ...
            " */\n"
            "void\n"
            "dft5 (real2_t * v0, real2_t * v1, real2_t * v2, real2_t * v3, real2_t * v4)\n"
            "{\n"
        ...
        case 7: return invert ?
            ...
            " * 54 stack variables, 6 constants, and 28 memory accesses\n"
            " */\n"
            "void\n"
            "dft7 (real2_t * v0, real2_t * v1, real2_t * v2, real2_t * v3, real2_t * v4,\n"
            "      real2_t * v5, real2_t * v6)\n"
            "{\n"
            ...
            "        {\n"
            "            real_t Tb, Ti, Tj, Tf, Tq, T4, To, Ta, Tg, TB, TL, Tp, T7, Tw, Tr;\n"
            "            real_t TD, TQ, TH, Te;\n"
            "            Tb = (*v0).s1;\n"
            "            T1 = (*v0).s0;\n"
            "            {\n"
            ...
            "            }\n"
            "            {\n"
            "                real_t Tk, TG, Th, TJ, Tt, TO, Ty, Ts, TU, Tm, TR, TI, TT, Tl;\n"
            "                TI = Tj - Ti;\n"
            "                Tk = Ti + Tj;\n"
            "                TG = Tg - Tf;\n"
            "                Th = Tf + Tg;\n"
            ...
            " * This function contains 60 FP additions, 42 FP multiplications,\n"
            " * (or, 18 additions, 0 multiplications, 42 fused multiply/add),\n"
            " * 50 stack variables, 6 constants, and 28 memory accesses\n"
            " */\n"
            "void\n"
            "dft7 (real2_t * v0, real2_t * v1, real2_t * v2, real2_t * v3, real2_t * v4,\n"
            "      real2_t * v5, real2_t * v6)\n"
            ...
            "        {\n"
            "            real_t T1, Th, Ti, Tk, Tl, TI, T4, TG, Ta, TT, Tp, TH, T7, TJ, TO;\n"
            "            real_t Tu, Tb, TB, Tg;\n"
            "            Tz = (*v0).s1;\n"
            "            T1 = (*v0).s0;\n"
            "            {\n"
        ...
        case 8: return invert ?
            ...
            " * 35 stack variables, 1 constants, and 32 memory accesses\n"
            " */\n"
            "void\n"
            "dft8 (real2_t * v0, real2_t * v1, real2_t * v2, real2_t * v3, real2_t * v4,\n"
            "      real2_t * v5, real2_t * v6, real2_t * v7)\n"
            "{\n"
            ...
            "        real_t TF, TE, TD, TI;\n"
            "        {\n"
            "            real_t TB, T3, Tn, Ti, To, T6, TC, Tl, Td, TN, Tz, TH, Ta, Tq, Tt;\n"
            "            real_t TM;\n"
            "            {\n"
            "                real_t Tj, T4, T5, Tk;\n"
            "                {\n"
            ...
            "        real_t TF, TE, TD, TI;\n"
            "        {\n"
            "            real_t Tn, T3, TC, Ti, TB, T6, To, Tl, Td, TN, Tz, TH, Ta, Tq, Tt;\n"
            "            real_t TM;\n"
            "            {\n"
            "                real_t Tj, T4, T5, Tk;\n"
            "                {\n"
        ...
        case 9: return invert ?
            ...
            " * 58 stack variables, 10 constants, and 36 memory accesses\n"
            " */\n"
            "void\n"
            "dft9 (real2_t * v0, real2_t * v1, real2_t * v2, real2_t * v3, real2_t * v4,\n"
            "      real2_t * v5, real2_t * v6, real2_t * v7, real2_t * v8)\n"
            "{\n"
            ...
            "        {\n"
            "            real_t TY, TC, TB, T5, Tl, TX, Tr, Tb, Ta, Tq, TJ, T17, TG, T18,\n"
            "                Ts;\n"
            "            real_t Tc, Td, Tt;\n"
            "            {\n"
            ...
            "        {\n"
            "            real_t Tm, TM, TL, T5, Tl, T1f, Tt, Tb, Ta, T1c, TI, TX, TF, TW,\n"
            "                Tp;\n"
            "            real_t Tc, Td, Tq;\n"
            "            {\n"
            "                real_t Th, T1, Ti, Tj, T4, T2, T3;\n"
        ...
        case 11: return invert ?
            ...
            " * 85 stack variables, 10 constants, and 44 memory accesses\n"
            " */\n"
            "void\n"
            "dft11 (real2_t * v0, real2_t * v1, real2_t * v2, real2_t * v3, real2_t * v4,\n"
            "       real2_t * v5, real2_t * v6, real2_t * v7, real2_t * v8, real2_t * v9,\n"
            "       real2_t * v10)\n"
            "{\n"
            ...
            "        {\n"
            "            real_t T1, TG, T4, TC, Tg, TF, T7, Ta, TD, Td, TI, T1S, T1J, TR,\n"
            "                T10;\n"
            "            real_t T21, T1m, T19, T1A, T1i, T1t, Tk, T1u, Tw, T1r, Tn, T1q,\n"
            "                Tq, T1s, Tt;\n"
            ...
            "        {\n"
            "            real_t T1f, T1u, T4, T1q, Tg, T1t, T7, T1s, Ta, Td, T1r, TP, T1X,\n"
            "                T26, Ti;\n"
            "            real_t TG, T1O, T1w, TY, T1F, T17, To, T1i, T1k, T1h, Tr, T1j, Tu,\n"
            "                T1g, Tx;\n"
            "            real_t T21, TU, TL, TC, T1S, T1J, T1m, T12, T1z, T1b;\n"
            "            T1f = (*v0).s1;\n"
            "            T1 = (*v0).s0;\n"
            "            {\n"
            "                real_t Tv, Tw, Ty, Tz, Tp, Tq, Tm, Tn, Ts, Tt, T1E, T16, Tb,\n"
            "                    Tc;\n"
            "                {\n"
            "                    real_t T2, T3, Te, Tf;\n"
            "                    Tv = (*v1).s1;\n"
        ...
        case 13: return invert ?
            ...
            " * 101 stack variables, 25 constants, and 52 memory accesses\n"
            " */\n"
            "void\n"
            "dft13 (real2_t * v0, real2_t * v1, real2_t * v2, real2_t * v3, real2_t * v4,\n"
            "       real2_t * v5, real2_t * v6, real2_t * v7, real2_t * v8, real2_t * v9,\n"
            "       real2_t * v10, real2_t * v11, real2_t * v12)\n"
            "{\n"
            ...
            "        {\n"
            "            real_t T1P, T1, T2n, T2o, To, TH, T2h, T2k, TE, TB, TF, Tw, T2j,\n"
            "                T2c, T1m;\n"
            "            real_t T1W, T1X, T1c, T19, T1j, T12, T1f, T21, T24, T27, T1U;\n"
            "            T1P = (*v0).s1;\n"
            "            T1 = (*v0).s0;\n"
            "            {\n"
            "                real_t TK, TL, T16, TY, TZ, T13, TW, TV, TN, TO, TQ, TR, T2b,\n"
            "                    Tv, Ts;\n"
            "                real_t T2a;\n"
            "                {\n"
            "                    real_t T2d, Tf, Tq, Ty, Tb, Tr, T6, Tx, Ti, Tt, Tu, Tl;\n"
            "                    {\n"
            ...
            "                }\n"
            "                {\n"
            "                    real_t T1R, TM, T10, T18, T1l, TX, T1k, T15, TP, T1a, T1b,\n"
            "                        TS, T17, T14;\n"
            "                    TF = Ts - Tv;\n"
            "                    Tw = Ts + Tv;\n"
            ...
            "                    {\n"
            "                        real_t TC, T1J, T1z, T1w, T1I, Tp, T1E, T1q, TI, T1s;\n"
            "                        {\n"
            "                            real_t TG, T1n, T1G, T1u, T1e, T1h, T1v, T1x, T1y,\n"
            "                                T1H, T1i;\n"
            ...
            "                    }\n"
            "                    {\n"
            "                        real_t T22, T2F, T2N, T2K, T2w, T2A, T1V, T2C, T28,\n"
            "                            T2y, T2M, T2q;\n"
            "                        {\n"
        ...
        case 16: return invert ?
            ...
            " * 81 stack variables, 3 constants, and 64 memory accesses\n"
            " */\n"
            "void\n"
            "dft16 (real2_t * v0, real2_t * v1, real2_t * v2, real2_t * v3, real2_t * v4,\n"
            "       real2_t * v5, real2_t * v6, real2_t * v7, real2_t * v8, real2_t * v9,\n"
            "       real2_t * v10, real2_t * v11, real2_t * v12, real2_t * v13,\n"
            "       real2_t * v14, real2_t * v15)\n"
            "{\n"
            ...
            "                T2h, T22, T1B;\n"
            "            real_t T1g, T1m, TQ, Te, T1S, T26, TJ, TT, T1n, T12, Tj, T11, Ti,\n"
            "                T1V, TZ;\n"
            "            real_t Tk, T13;\n"
            "            {\n"
            ...
            "                }\n"
            "                {\n"
            "                    real_t T29, T1T, T27, T2d, T2a, T2b, T28, T24, T1Y, T23;\n"
            "                    T29 = T1S + T1R;\n"
            "                    T1T = T1R - T1S;\n"
            "                    (*v4).s1 = Tv + TK;\n"
            "                    (*v4).s0 = T2j + T2k;\n"
            ...
            "                T2h, T22, T1D;\n"
            "            real_t T1g, T1n, TQ, Te, T26, TT, T1m, TJ, T1S, T12, Tj, T11, Ti,\n"
            "                T1V, TZ;\n"
            "            real_t Tk, T13;\n"
            "            {\n"
            "                real_t T1d, Tq, T1c, Tp, T20, T1a, Tr, T1e;\n"
        ...
        case 25: return invert ?
            ...
            " * 163 stack variables, 47 constants, and 100 memory accesses\n"
            " */\n"
            "void\n"
            "dft25 (real2_t * v0, real2_t * v1, real2_t * v2, real2_t * v3, real2_t * v4,\n"
            "       real2_t * v5, real2_t * v6, real2_t * v7, real2_t * v8, real2_t * v9,\n"
            "       real2_t * v10, real2_t * v11, real2_t * v12, real2_t * v13,\n"
            "       real2_t * v14, real2_t * v15, real2_t * v16, real2_t * v17,\n"
            "       real2_t * v18, real2_t * v19, real2_t * v20, real2_t * v21,\n"
            "       real2_t * v22, real2_t * v23, real2_t * v24)\n"
            "{\n"
            ...
            "        {\n"
            "            real_t T4E, T3e, T9, T1R, T45, T1U, T46, T1D, T4D, T3b, Ts, T1K,\n"
            "                T18, T1E, T4w;\n"
            "            real_t T5f, T3A, T22, T4s, T5c, T3D, T2o, T3C, T2h, T4p, T5b, T4z,\n"
            "                T5e, T3z, T29;\n"
            "            real_t T2z, T2y, TL, T1L, T1r, T1F, T4k, T54, T3w, T2x, T4a, T58,\n"
            "                T3t, T2T, T2D;\n"
            ...
            "                {\n"
            "                    real_t TQ, Ta, TZ, Tj, T26, T27, Th, T1X, T1Z, T20, TX,\n"
            "                        T2e, T2f, Tq, T2j;\n"
            ...
            "                }\n"
            "                {\n"
            "                    real_t T19, Tt, T1i, TC, T2B, T2C, TA, T2s, T2u, T2v, T1g,\n"
            "                        T2Q, T2R, TJ, T2H;\n"
            ...
            "                        {\n"
            "                            real_t T1a, Tu, Tv, T1b, T1d, Tx, Ty, T1e, Tw, Tz;\n"
            "                            T1a = (*v7).s1;\n"
            "                            Tu = (*v7).s0;\n"
            ...
            "                        }\n"
            "                        {\n"
            "                            real_t T1j, TD, TE, T1k, T1m, TG, TH, T1n, TF, TI;\n"
            "                            T1j = (*v8).s1;\n"
            "                            TD = (*v8).s0;\n"
            "                            T2z = T1f - T1c;\n"
            "                            T1g = T1c + T1f;\n"
            ...
            "            }\n"
            "            {\n"
            "                real_t T4h, T55, T3v, T3r, T3H, T3k, T36, T38, T3o, T3q, T3j,\n"
            "                    T2Z, T37;\n"
            "                {\n"
            ...
            "                            {\n"
            "                                real_t T30, T2a, T2p, T31, T33, T2F, T2U, T34,\n"
            "                                    T2q, T2V;\n"
            ...
            "                }\n"
            "                {\n"
            "                    real_t T4F, T47, T5A, T5s, T5u, T5E, T5G, T5z, T5l, T5t;\n"
            "                    {\n"
            "                        real_t T53, T5v, T5C, T5D, T5i, T5k, T5o, T5x, T5w,\n"
            "                            T5r, T3p, T3l, T5y, T5j;\n"
            ...
            "                            {\n"
            "                                real_t T4G, T4e, T4l, T4H, T4J, T4t, T4A, T4K,\n"
            "                                    T4m, T4B;\n"
            ...
            "                            {\n"
            "                                real_t T3I, T3u, T3x, T3J, T3L, T3B, T3E, T3M,\n"
            "                                    T3y, T3F;\n"
            ...
            "        real_t T3Y, T3U, T3W, T42, T44, T3X, T3R, T3V, T3Z, T43;\n"
            "        {\n"
            "            real_t T4Q, T1U, T9, T3b, T45, T3e, T46, T1D, T4P, T1R, Ts, T1K,\n"
            "                T18, T1E, T4z;\n"
            "            real_t T5f, T3z, T22, T4s, T5b, T3C, T2o, T3D, T2h, T4p, T5c, T4w,\n"
            "                T5e, T3A, T29;\n"
            "            real_t T2z, T2y, TL, T1L, T1r, T1F, T4a, T57, T3v, T2x, T4k, T55,\n"
            "                T3s, T2T, T2D;\n"
            ...
            "                {\n"
            "                    real_t TQ, Ta, TZ, Tj, T1Z, T20, Th, T26, T27, T1X, TX,\n"
            "                        T2l, T2m, Tq, T2c;\n"
            ...
            "                }\n"
            "                {\n"
            "                    real_t T19, Tt, T1i, TC, T2u, T2v, TA, T2B, T2C, T2s, T1g,\n"
            "                        T2J, T2K, TJ, T2O;\n"
            ...
            "            }\n"
            "            {\n"
            "                real_t T4d, T58, T3w, T3H, T3r, T3k, T36, T38, T3o, T3q, T3j,\n"
            "                    T2Z, T37;\n"
            "                {\n"
            "                    real_t TM, T2E, T1s, T1u, TP, T1t;\n"
            "                    {\n"
            ...
            "                }\n"
            "                {\n"
            "                    real_t T47, T4R, T5A, T5w, T5y, T5E, T5G, T5z, T5t, T5x;\n"
            "                    {\n"
            "                        real_t T53, T5j, T5u, T5v, T5i, T5D, T5m, T5p, T5C,\n"
            "                            T3p, T3l, T5s, T5q, T5r;\n"
            "                        T47 = fma (KP951056516, T46, T45);\n"
            ...
            "                            {\n"
            "                                real_t T4J, T4e, T4l, T4K, T4G, T4t, T4A, T4H,\n"
            "                                    T4m, T4B;\n"
